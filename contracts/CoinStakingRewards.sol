...
contract CoinStakingRewards is ReentrancyGuard, ERC1155Holder{
    ...
    function setNotifyRewardAmount(uint256 amount)  external  updateReward(msg.sender) onlySupplyController(msg.sender) {
    ...
    function notifyRewardAmount(uint256 reward) public  nonReentrant updateReward(msg.sender) onlySupplyController(msg.sender){
    ...
    modifier onlySupplyController(address owners) {
