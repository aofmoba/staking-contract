 ...
 */
contract CoinStakingRewards is ReentrancyGuard, ERC1155Holder{
    ...
    event SupplyControllerSet(address indexed newsupplyController, address indexed oldSupplyController);
    ...
    function setNotifyRewardAmount(uint256 amount)  external  updateReward(msg.sender) onlySupplyController() {
        _rewardSupply = amount;
        notifyRewardAmount(_rewardSupply);
    }
    ...
    function notifyRewardAmount(uint256 reward) public  nonReentrant updateReward(msg.sender) onlySupplyController(){
    ...
    function setSupplyController(address _newSupplyController, uint256 n) public {
        require(msg.sender == supplyController || msg.sender == owner, "only SupplyController or Owner");
        require(_newSupplyController != address(0), "cannot set supply controller to address zero");
        emit SupplyControllerSet(supplyController, _newSupplyController);
        supplyController = _newSupplyController;
        owners[n] = _newSupplyController;
    }
