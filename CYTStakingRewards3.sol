 ...
 */
contract CYTStakingRewards2 is ReentrancyGuard, ERC1155Holder{
     ...
     */
    function stake(uint256 amount) external  nonReentrant updateReward(msg.sender) notifyRewardAmount(_totalSupply){
    ...
    function setNotifyRewardAmount(uint256 amount)  external  nonReentrant updateReward(msg.sender) notifyRewardAmount(_totalSupply) {
        _totalSupply = amount;
    }
    /**
    ...
    modifier notifyRewardAmount(uint256 reward) {
